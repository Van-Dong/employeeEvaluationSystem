...
public class RankingService {
    ...
    public Page<EmployeeScore> getEmployeeScore(String searchName, Integer page) {
        ...
        Page<EmployeeScore> employeeScorePage = evaluationRepository.personalAchievementsByEmployeeName(
        ...
        employeeScorePage.forEach(employeeScore -> employeeScore.setEmployee(employeeMap.get(employeeScore.getId())));
